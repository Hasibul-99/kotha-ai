...
export default function ChatContent() {
  ...
  return (
    <>
      ...
      <div className='flex items-start p-6 gap-6 bg-white border-t border-[#E4E4E4]'>
        <div className='w-full'>
          <input
            className='h-14 w-full flex items-center px-4 gap-2 bg-[#F9F9F9] border border-[#E4E4E4] rounded-lg'
...
const ChatMessage = ({userImage, message, userIcon, additionalIcons}) => (
  <div className='flex items-start gap-4'>
    ...
    <div className='flex flex-col md:flex-row items-start gap-4'>
      <div className='md:max-w-[70%] p-4 bg-white border border-[#E4E4E4] rounded-lg font-medium text-[14px] leading-[140%] text-[#000A11]'>
        {message}
      </div>
      <div className='flex items-start gap-4'>
